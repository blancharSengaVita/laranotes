...
{{--                        @endif--}}
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                <label for="description" class="block text-sm font-medium leading-6 text-gray-900">description (can not be empty) </label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-full">
                                ...
                                <input type="file" name="image_url" id="thumbnail">
                                <div>
